...
async def fetch_next_120k():
    logger.info("="*60)
    logger.info("🚀 INICIANDO O RESGATE DAS 120.000 PEDRAS SEGUINTES (Ignorando as primeiras 90.000)...")
    logger.info("="*60)
    ...
    total_saved = 0
    start_page = 901
    end_page = 2100 # 1200 páginas = 120k pedras
    ...
    async with httpx.AsyncClient(timeout=15.0, headers=headers) as client:
        for page in range(start_page, end_page + 1):
            ...
            if page % 25 == 0 or page == end_page:
                logger.info(f"📊 Página {page}/{end_page} salva. Total até agora: {total_saved} pedras.")
